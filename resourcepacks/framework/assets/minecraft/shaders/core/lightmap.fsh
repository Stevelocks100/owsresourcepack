...
void main() {
    ...
    if (apply_base_skybox(CameraBlockPos - CameraOffset) > 0) {
        color += mix(lightmapInfo.SkyLightColor * sky_brightness,base_lightmap(),apply_base_skybox(CameraBlockPos - CameraOffset));
    } else {
